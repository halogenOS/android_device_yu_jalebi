...
# Kernel
TARGET_GCC_VERSION := 6.2.1
TARGET_GCC_VERSION_ARM := 6.2.1-kernel
TARGET_KERNEL_CROSS_COMPILE_PREFIX := arm-eabi-
KERNEL_TOOLCHAIN := $(ANDROID_BUILD_TOP)/prebuilts/gcc/$(strip $(HOST_OS))-x86/arm/$(TARGET_KERNEL_CROSS_COMPILE_PREFIX)6.2.1-kernel/bin
TARGET_TOOLCHAIN_ROOT := $(ANDROID_BUILD_TOP)/prebuilts/gcc/$(strip $(HOST_OS))-x86/arm/$(TARGET_KERNEL_CROSS_COMPILE_PREFIX)6.2.1/bin
